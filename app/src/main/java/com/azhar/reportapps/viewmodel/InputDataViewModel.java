...
public class InputDataViewModel extends AndroidViewModel {
    ...
    public void addLaporan(final String kategori, final String image,final  String username,final String password,
                              final String nama, final String lokasi, final String tanggal,final String isi_laporan,final String telepon) {
        Completable.fromAction(() -> {
            ...
            modelDatabase.username = username;
            modelDatabase.password = password;
    ...
    public void addLaporan2(final String kategori, final String image,
                            final String nama, final String lokasi, final String tanggal,final String isi_laporan,final String telepon)
    {  Completable.fromAction(() -> {
        ModelDatabase modelDatabase = new ModelDatabase();
        modelDatabase.kategori = kategori;
